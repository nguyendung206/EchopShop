...
<div class="filter">
    <form class="" id="food" action="{{ route('admin.brand.index') }}" method="GET">
        <div class="row gutters-5 mb-2">
            ...
            <div class="col-md-3 text-md-right download" style="padding-left: 3px">
                <a href="/assets/theme/import_brand.xlsx" type="button" class=" pl-0 pr-0 btn btn-info w-100 mr-2 d-flex btn-responsive justify-content-center">
        ...
        <div class="row gutters-5 mb-3 custom-change">
            ...
            <div class="col-md-6 d-flex">
                ...
                <button class="btn btn-info w-25 btn_import ml-2 d-flex btn-responsive justify-content-center"
                         type="button" id="uploadButtonBrand">
    ...
    <form action="{{ route('admin.brand.import') }}" method="POST" enctype="multipart/form-data" id="importFormBrand">
        @csrf
        <input type="file" name="fileImport" accept=".xls,.xlsx,.csv" id="fileImportBrand" class="d-none">
...
<script>
    $(document).ready(function() {
        ...
        $('#fileImportBrand').on('change', function() {
            $('#importFormBrand').submit();
        });
