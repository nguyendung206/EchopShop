...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><strong>@lang('Chỉnh sửa sản phẩm cần phê duỵệt')</strong></h1>
    </div>
</div>
<div class="filter">
    <form class="" id="food" action="{{ route('admin.wait.index') }}" method="GET">
        ...
        <table class="table aiz-table mb-0 table_repon">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="font-weight-400 align-middle">{{$data->shop->name}}</td>
                    <td>{{ $data->status->label() }}</td>
                    <td class="text-center">
                        <a class="btn mb-1 btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('admin.wait.show', $data->product_id) }}" title="@lang('Show')">
                            <i class="las la-bars"></i>
                        </a>
                        <a class="btn mb-1 btn-soft-danger btn-icon btn-circle btn-sm btn_status wait"
                            data-id="{{ $data->id }}"
                        ...
                        <a class="btn btn-soft-success btn-icon btn-circle btn-sm btn_status wait"
                            data-id="{{ $data->id }}"
                            data-product-id="{{ $data->product_id }}"
