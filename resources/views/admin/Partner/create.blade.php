            ...
            <div class="card-body">
                <form action="{{route('admin.partner.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="font-weight-500 form-control @error('status') is-invalid  @enderror" name="status" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img id="photo_preview" src="{{ getImage('nophoto.png')}}" class="mt-4 img img-bordered" style="width:200px" />
