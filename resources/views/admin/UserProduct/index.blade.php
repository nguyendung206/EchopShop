...
<div class="filter">
    <form class="" id="food" action="{{ route('admin.userproduct.index') }}" method="GET">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="text-center">
                        <a class="btn mb-1 btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('admin.userproduct.show', $data->id) }}" title="@lang('Show')">
                            <i class="las la-bars"></i>
                        </a>
                        @if ($data->status->value == 1)
                        <a class="btn mb-1 btn-soft-danger btn-icon btn-circle btn-sm btn_status changeStatus"
                            data-id="{{ $data->id }}"
                            data-href="{{ route('admin.userproduct.changestatus', ['id' => $data->id]) }}"
