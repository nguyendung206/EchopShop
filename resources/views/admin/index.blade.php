            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-day2" role="tabpanel" aria-labelledby="pills-day2-tab">
                    <div class="card-body-title d-flex">
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total_food')}}: <b>123</b> </h6>
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total_combo')}}: <b>1123</b> </h6>
                    </div>
                    <div class="card-body">
                        <div class="chart">
                ...
                <div class="tab-pane fade" id="pills-week2" role="tabpanel" aria-labelledby="pills-week2-tab">
                    <div class="card-body-title d-flex">
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total')}}: 123213 </h6>
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total_combo')}}: <b>123123</b> </h6>
                    </div>
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="day2" class="w-100" height="90"></canvas>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-jun2" role="tabpanel" aria-labelledby="pills-jun2-tab">
                    <div class="card-body-title d-flex">
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total')}}:123</h6>
                        <h6 class="card-title label ml-4 mt-2">{{__('dashboards.total_combo')}}: <b>123</b> </h6>
                    </div>
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="month2" class="w-100" height="90"></canvas>
                        </div>
                    </div>
                </div>
            </div>
