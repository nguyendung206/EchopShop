...
<div class="filter">
    <form class="" id="food" action="{{ route('banner.index') }}" method="GET">
        <div class="row gutters-5 mb-2">
            ...
            <div class="col-md-3 text-md-right add-new ">
                <a href="{{route('banner.create')}}" class="btn btn-info btn-add-food d-flex justify-content-center">
            ...
            <tbody>
                ...
                @foreach ($banners as $key => $banner)
                    <tr class="text-center">
                        ...
                        <td class="font-weight-400 align-middle">
                        <form action="{{ route('banner.updateStatus', $banner->id)}}" id="status-form-{{$banner->id}}" method="POST"  style="display: inline-block">
                            @csrf
                            @method("PUT")
