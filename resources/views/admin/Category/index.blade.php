...
<div class="filter">
    <form class="" id="food" action="{{ route('admin.category.index') }}" method="GET">
        <div class="row gutters-5 mb-2">
            ...
            <div class="col-md-3 text-md-right add-new ">
                <a href="{{route('admin.category.create')}}" class="btn btn-info btn-add-food d-flex justify-content-center">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="text-right">
                            @if ($data->status->value == 1)
                                ...
                                data-href="{{ route('admin.category.changestatus', ['id' => $data->id]) }}" id="active-popup" title="@lang('user.deactivate')">
                                    <i class="las la-ban"></i>
                                </a>
                            @else
                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm btn_status" data-id="{{ $data->id }}" 
                                data-href="{{ route('admin.category.changestatus', ['id' => $data->id]) }}" id="inactive-popup" title="@lang('user.active')">
                                    <i class="las la-check-circle"></i>
                                </a>
                            @endif
                            <a class="btn mb-1 btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('admin.category.edit', $data->id) }}"  title="@lang('Update')">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="javascript:void(0)" data-href="{{ route('admin.category.destroy', $data->id) }}" data-id="{{$data->id}}" class="btn btn-delete btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" title="@lang('user.delete')">
