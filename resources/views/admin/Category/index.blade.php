                    ...
                    <tr class="text-center">
                        ...
                        <td class="text-right">
                            @if ($data->status->value == 1)
                                ...
                                data-href="{{ route('category.changestatus', ['id' => $data->id]) }}" id="active-popup" title="@lang('user.deactivate')">
                                    <i class="las la-ban"></i>
                                </a>
                            @else
                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm btn_status" data-id="{{ $data->id }}" 
                                data-href="{{ route('category.changestatus', ['id' => $data->id]) }}" id="inactive-popup" title="@lang('user.active')">
