...
@section('content')
    ...
    <div class="filter">
        <form class="" id="food" action="{{ route('admin.category.index') }}" method="GET">
            <div class="row gutters-5 mb-2">
                ...
                <div class="col-md-3 text-md-right download" style="padding-left: 3px">
                    <a href="/assets/theme/import_category.xlsx" download type="button"
        ...
        <form action="{{ route('admin.category.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
            @csrf
            <input type="file" name="fileImport" accept=".xls,.xlsx,.csv" id="fileImport" class="d-none">
