                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class=" form-control font-weight-500" name="status" >
                                <option class=" " value="{{App\Enums\Status::ACTIVE}}" {!! old('status') != null && old('status') == 0 ? ' selected' : null !!}>Đang hoạt động</option>
                                <option class=" " value="{{App\Enums\Status::INACTIVE}}" {!! old('status') != null && old('status') == 1 ? ' selected' : null !!}>Đã bị khoá</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
