...
<div class="backnow">
    <div class="backpage">
        <a href="" class="back btn"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card-body">
                <form action="{{route('category.save')}}" method="POST">
                    ...
                    <div class="form-group mb-0 text-right">
                        <a href="{{route('admin.users.index', session('old_query'))}}" type="button" class="btn btn-light mr-2">@lang('cancel')</a>
