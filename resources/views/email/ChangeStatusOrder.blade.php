        ...
        <form>
          ...
          <table>
            <thead>
              ...
              <tr>
                <td colspan="4">
                    <div class="text-right total-price-purchase col-6">Giá gốc: <span class="discount-money">{{format_price($order->total_amount)}}</span> </div>
                  @if ($order->discount)
                  <div class="text-right total-price-purchase col-6">Giảm giá: <span class="discount-money">{{format_price(calculateDiscountAmount($order->discount->type->value, $order->total_amount, $order->discount->value, $order->discount->max_value))}}</span></div>
                  <div class="text-right total-price-purchase col-6">Thành tiền:<span class="discount-money">{{format_price(calculateDiscountedPrice($order->discount->type->value, $order->total_amount, $order->discount->value, $order->discount->max_value))}}</span></div>
            ...
            Vui lòng theo dõi email để cập nhật thông tin mới
      </main>
</body>
</html>