                ...
                <div class="information-receive">
                    @if ($user->defaultAddress == null)
                        <form action="{{ route('order.addAddress') }}" method="POST">
                            @csrf
                            <div class=" row" id="">
                                <h6 class="col-12 mt-3 mb-4">Vui lòng thêm địa chỉ của bạn</h6>
                                <div class="form-group col-12">
                                    <label class="address-label">Tên người nhận<span
                                            class="text-vali">&#9913;</span></label>
                                    <div class="">
                                        <input type="text" placeholder="Nhập tên người nhận" name="user_name"
                                            class="form-control" value="{{ old('user_name') }}">
                                    </div>
                                    @error('user_name')
                                        <div style="font-size: 12px; color: red; margin-top: 8px">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-lg-6 col-12">
                                    ...
                                    <div class="">
                                        <input type="text" placeholder="Nhập số điện thoại" id="phoneNumberForm"
                                ...
                                <div class="form-group col-12">
                                    <label class="address-label">Thành Phố<span
                                            class="text-vali">&#9913;</span></label></label>
                                    <div class="">
                                        <select class="text-center form-control font-weight-500" name="province_id"
                                            id="province_select">
                                            <option class=" text-center" value="0" disabled selected>Tỉnh/Thành phố *
                                            </option>
                                ...
                                <div class="form-group col-lg-6 col-12">
                                    ...
                                    <div class="">
                                        <select class="text-center form-control font-weight-500" name="district_id"
                                            id="district_select">
                                            <option value="0" class=" text-center" disabled selected>Quận/Huyện *
                                            </option>
                                            <option value="0" class=" text-center" disabled>Vui lòng chọn thành phố
                                                trước
                                            </option>
                                        </select>
                                        @error('district_id')
                                ...
                                <div class="form-group col-lg-6 col-12">
                                    ...
                                    <div class="">
                                        <select class="text-center form-control font-weight-500" name="ward_id"
                                            id="ward_select">
                                            <option value="0" class=" text-center" disabled selected>Phường/Thị xã *
                                            </option>
                                            <option value="0" class=" text-center" disabled>Vui lòng chọn quận huyện
                                                trước
                                            </option>
                                        </select>
                                        @error('ward_id')
                                ...
                                <div class="form-group col-12">
                                    <input type="radio" name="type_address" value="{{ TypeAddressEnums::HOME->value }}"
                                        checked> <span class="ml-1" style="color: rgba(0,0,0,0.54);">Nhà riêng</span>
                                ...
                                <div class="col-12 text-right">
                                    <button class="buy b-radius" id="addDefaultAddress" type="submit">Thêm địa
                                        chỉ</button>
                                </div>
                            </div>
                        </form>
                                ...
                                <td class="align-middle">
                                    <div class="infor-cart">
                                        ...
                                        <div class="item-details ml-3">
                                            ...
                                            <div class="type-show">
                                                @if (
                                                    !empty($cart->products->getProductUnitById($cart->product_unit_id)->size) &&
                                                        !empty($cart->products->getProductUnitById($cart->product_unit_id)->color))
                                                    <p>Phân loại hàng:</p>
                                                    <div class="type-size-{{ $cart->id }}"> &nbsp; size
                                                        {{ $cart->products->getProductUnitById($cart->product_unit_id)->size }},
                                                    </div>
                                                    <div class="type-color-{{ $cart->id }}">&nbsp; màu
                                                        {{ $cart->products->getProductUnitById($cart->product_unit_id)->color }}.
                                                    </div>
                                                @endif
                                    ...
                                    <div class="content-pay">
                                        ...
                                        <div class="infor-shipper col-lg-9">
                                            ...
                                            <div class="total-last col-lg-12">Tổng số tiền(<span
                                                    style="color: #B10000">{{ $orderCarts->count() }}</span>):
                                                <b>{{ format_price($sum) }}</b></div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="row align-items-center">
                            ...
                            <div class="voucher-modal" id="voucherModal">
                                ...
                                <div class="voucher-code">
                                    ...
                                    <div class="col-9 code-input">
                                        ...
                                        <p class="btn-show-voucher b-radius submitVoucher btn-apply-voucher line-clamp-1 "
                                            style="text-align: center; display: block;" data-voucher="code"
                                            type="button">Áp dụng</p>
                                    </div>
                                    ...
                                    @forelse ($vouchers as $voucher)
                                        <div class="voucher-item col-12">
                                            ...
                                            <div class="voucher-content col-6">
                                                ...
                                                <p>Giảm:
                                                    {{ $voucher->type == TypeDiscountEnums::PERCENT ? $voucher->value . ' %' : format_price($voucher->value) }}
                                                </p>
                                                ...
                                                @php
                                                    ...
                                                    $userId = Auth::id();
                                                    $numberUsed = count(
                                                        array_filter($userUsedArray, function ($id) use ($userId) {
                                                            return $id == $userId;
                                                        }),
                                                    );
                                                @endphp
                                                ...
                                                @if ($voucher->scope_type->value == TypeDiscountScopeEnums::REGIONAL->value)
                                                    <p class="mt-1 text-left">Chỉ cho khu vực:
                                                        ...
                                                        @if (optional($voucher->ward)->ward_name)
                                                            ,
                                                        @endif
                                                        {{ optional($voucher->district)->district_name }}
                                                        @if (optional($voucher->district)->district_name)
                                                            ,
                                                        @endif
                                                        {{ optional($voucher->province)->province_name }}.
                                                    </p>
                                                @endif
                                            </div>
                                            <div class="voucher-button col-3">
                                                ...
                                                @else
                                                    <input class=" d-block" type="radio" name="radioVoucher"
                                                        id="radio-{{ $voucher->id }}" value="{{ $voucher->id }}">
                                                @endif
                                            </div>
                                        </div>
                                    @empty
                                        <p class="align-middle text-center my-3 w-100" style="color: #B10000">Hiện không
                                            có mã giảm giá nào.</p>
                                    @endforelse
                                ...
                                <div class="voucher-wrap-button col-12 text-right pt-2">
                                    ...
                                    <button class="buy b-radius submitVoucher" type="button" data-voucher="radio">Áp
                                        dụng</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="total-price-pay-method col-lg-7 col-12">
                        ...
                        <div class="shipper-price pb-2">
                            ...
                            <b>{{ $feeship ? format_price($feeship->feeship) : 'Chưa rõ' }}</b>
                        </div>
                        ...
                        @if ($user->defaultAddress)
                            ...
                            <div class="button-pay text-right"><button class="b-radius" type="submit">Đặt hàng</button>
                            </div>
                        @else
                            <div class="button-pay text-right"><a href="{{ route('profile.address') }}"
                                    class="b-radius">Thêm địa chỉ để đặt hàng</a></div>
                        @endif
                    </div>
                </div>
    ...
    <div class="address-layer" id="addressShowLayer">
        <form action="{{ route('order.changeAddress') }}" method="POST" id="changeAddressShowForm">
            <div class="address-modal row" id="addressModal">
                ...
                <div class="address-content-wrap col-12">
                    @foreach ($shippingAddresses as $address)
                        <div class="form-group col-12 row align-items-center"
                            style="margin-left: 0px; margin-right: 0px;">
                            <div class="col-2"><input type="radio" name="radio-address"
                                    data-shipping-address-id="{{ $address->id }}"
                                    {{ $address->is_default == true ? 'checked' : '' }}></div>
                            <div class="col-8">
                                <p class="my-1">{{ $address->user_name }}</p>
                                <p class="my-1" style="color: rgba(0,0,0,0.54);">(+84) {{ $address->phone }}</p>
                                <p class="my-1" style="color: rgba(0,0,0,0.54);">{{ $address->street }},
                                    {{ $address->ward->ward_name }}, {{ $address->district->district_name }},
                            ...
                            <div class="col-2">
                                <button class="btn btn-update-address"
                                    style="font-size: 10px;background-color: transparent;color: #B10000;"
                                    data-shipping-address-id="{{ $address->id }}" type="button">Cập nhật</button>
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="col-12">
                    ...
                    <button type="button" class="change-address p-1 b-radius my-2" id="btn-add-address"
                        style="font-size: 10px">Thêm địa chỉ mới</button>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#district_select').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (@json(old('ward_id'))) {
                                $('#ward_select').val(@json(old('ward_id'))).change();
                            }
                ...
                $('#province_select').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (@json(old('district_id'))) {
                                $('#district_select').val(@json(old('district_id'))).change();
                            }
                ...
                $('input[name="radio-address"]').change(function() {
                    var addressId = $(this).closest('.form-group').find('.btn-update-address').data(
                        'shipping-address-id');
                ...
                $('#submitChangeAddressShow').on('click', function() {
                    ...
                    var addressIdSelected = $('input[name="radio-address"]:checked').data(
                    'shipping-address-id');

                    var addressSelected = @json($shippingAddresses).find(function(address) {
                        return address.id == addressIdSelected;
                    });
                    $('.infor-address').html('<b class="mr-3">' + addressSelected.user_name + ' (+84) ' +
                        addressSelected.phone + ' </b>' +
                        addressSelected.street + ', ' + addressSelected.ward.ward_name + ', ' +
                        addressSelected.district.district_name + ', ' + addressSelected.province
                        .province_name
                    );
                        ...
                        success: function(response) {
                            ...
                            if (response.vouchers.length > 0) {
                                response.vouchers.forEach(voucher => {
                                    ...
                                    var userUsedArray = voucher.user_used ? voucher
                                        .user_used.split(',') : [];
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#submitChangeAddress').click(function(e) {
                    ...
                    let hasError = false;
                    if (!nameValue) {
                        $('#changeAddressForm input[name="user_name"]').after(
                            '<span class="error-message text-danger my-1" style="font-size: 10px">Vui lòng nhập tên người nhận.</span>'
                            );
                        hasError = true;
                    }
                    if (!addressValue) {
                        $('#addressForm').after(
                            '<span class="error-message text-danger my-1" style="font-size: 10px">Vui lòng nhập địa chỉ.</span>'
                            );
                        hasError = true;
                    }
                    ...
                    if (!phoneNumberValue) {
                        $('#phoneNumberForm').after(
                            '<span class="error-message text-danger my-1" style="font-size: 10px">Vui lòng nhập số điện thoại.</span>'
                            );
                        hasError = true;
                    } else if (!phoneRegex.test(phoneNumberValue)) {

                        $('#phoneNumberForm').after(
                            '<span class="error-message text-danger my-1" style="font-size: 10px">Số điện thoại không hợp lệ. Vui lòng nhập lại.</span>'
                            );
                        hasError = true;
                    }
                    if (hasError) {
                ...
                $('.submitVoucher').click(function(e) {
                    ...
                    if (voucherType == 'code' && voucherCodeInput.length > 0) {
                        ...
                        if (voucherSelected) {
                            if (voucherSelected.user_used.split(',').filter(id => id ==
                                    @json(Auth::id())).length >= voucherSelected.limit_uses) {
                                $('#errorCode').empty();
                                $('#errorCode').append(`
                    ...
                    if (voucherSelected != null) {
                        ...
                        $('.sum-pay').text(format_price(calculateDiscountedPrice(voucherSelected.type,
                            @json($sum), voucherSelected.value, voucherSelected
                            .max_value)))
                        toastr.success("Áp dụng mã thành công", null, {
                            positionClass: 'toast-bottom-left'
                        });
                    }
                    return;
                ...
                @if (old('province_id'))
                    $('#province_select').val("{{ old('province_id') }}").change();
                @endif
